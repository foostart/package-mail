                        ...
                        <div class="col-md-12 col-xs-12">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a data-toggle="tab" href="#home">
                                        {!! trans('mail::mail_admin.tab_overview') !!}
                                    </a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="#menu1">
                                        {!! trans('mail::mail_admin.tab_attributes') !!}
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="menu1" class="tab-pane fade">
                                    ...
                                    @include('mail::mail.elements.select', ['name' => 'mail_categoty_name'])
                            ...
                            <!-- DELETE BUTTON -->
                            <a href="{!! URL::route('admin_mail.delete',['id' => @$mail->mail_id, '_token' => csrf_token()]) !!}"
