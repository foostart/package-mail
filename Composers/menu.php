...
|   $sorting
|   $order_by
|   $plang_admin = 'mail-admin'
|   $plang_front = 'mail-front'
*/
View::composer([
                'package-mail::admin.mail-edit',
                'package-mail::admin.mail-form',
                'package-mail::admin.mail-items',
                'package-mail::admin.mail-item',
                'package-mail::admin.mail-search',
                'package-mail::admin.mail-config',
                'package-mail::admin.mail-lang',
    ], function ($view) {
        ...
        $key = $fooCategory->getContextKeyByRef('admin/mails');
        /**
         * $sidebar_items
         */
        $view->with('sidebar_items', [
            trans('mail-admin.sidebar.add') => [
                'url' => URL::route('mails.edit', []),
                'icon' => '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>'
            ],
            trans('mail-admin.sidebar.list') => [
                "url" => URL::route('mails.list', []),
                'icon' => '<i class="fa fa-list-ul" aria-hidden="true"></i>'
            ],
            trans('mail-admin.sidebar.category') => [
                'url'  => URL::route('categories.list',['_key='.$key]),
                'icon' => '<i class="fa fa-sitemap" aria-hidden="true"></i>'
            ],
            trans('mail-admin.sidebar.config') => [
                "url" => URL::route('mails.config', []),
                'icon' => '<i class="fa fa-braille" aria-hidden="true"></i>'
            ],
            trans('mail-admin.sidebar.lang') => [
                "url" => URL::route('mails.lang', []),
        ...
        $orders = [
            ...
            'mail_name' => trans($plang_admin.'.fields.name'),
